...
final class WordCounts {
     ...
     *
     * <p>: this method using only the Stream API and lambdas and/or method
     * references.
     *
    ...
    static Map<String, Integer> sort(Map<String, Integer> wordCounts, int popularWordCount) {
         ...
         *     return topCounts;
         */
        return wordCounts.entrySet().stream().sorted(new WordCountComparator()).limit(Math.min(popularWordCount, wordCounts.size())).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (a, b) -> b, LinkedHashMap::new));
    }
